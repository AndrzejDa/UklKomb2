...
HD_PWD='D:/XilinxProjekty/UklKomb2/UklKomb2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UklKomb2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UklKomb2.tcl
