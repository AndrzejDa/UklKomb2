...
HD_PWD='D:/XilinxProjekty/UklKomb2/UklKomb2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UklKomb2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UklKomb2.tcl -notrace
